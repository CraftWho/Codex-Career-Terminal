...
- [x] Watch the JavaScript Essentials course on Scrimba.
- [x] Understand the Fetch API and how it handles promises.
- [x] Write the code to fetch data from `dp-data.json`.
- [x] Dynamically render your dashboard with the fetched data.

---

## 🚀 Checklist for Dynamic Updates

- [x] Fetch the data from `dp-data.json`.
- [x] Target each HTML element by its ID.
- [x] Assign the data to each element's `textContent`.
- [x] Test the page to confirm the data is showing.
- [x] Dynamically render your dashboard with the fetched data.
